...
def Sidebar(h2, h4):
    ...
    [col1, col2, col3] = st.sidebar.columns(3)
    with col1:
        j_margin = st.number_input(h4+':green[장선 간격 여유 [%]]', min_value = 10., value = 85., step = 1., format = '%f')
    with col2:
        y_margin = st.number_input(h4+':green[멍에 간격 여유 [%]]', min_value = 10., value = 85., step = 1., format = '%f')
    with col3:
        s_margin = st.number_input(h4+':green[서포트 간격 여유 [%]]', min_value = 10., value = 85., step = 1., format = '%f')
    ...
    [In.j_margin, In.y_margin, In.s_margin] = [j_margin, y_margin, s_margin]
    return In